    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right" style="display:flex; align-items: center;">
        ...
        <ul class="dropdown-menu">
          ...
          <li><asp:LinkButton ID="cerrarsesion" runat="server" OnClick="cerrarsesion_Click">Cerrar sesion</asp:LinkButton></li>
            ...
            <br />
            <asp:Label ID="lblNota" Text="Nota: Se cerrará la sesión una vez cambiada la clave." ForeColor="#4682B4" runat="server"></asp:Label>
                <br />
