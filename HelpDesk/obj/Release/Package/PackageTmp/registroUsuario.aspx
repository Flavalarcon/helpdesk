...
<script src="../js/bootstrap.min.js"></script>
        ...
        <center>
            <asp:Label ID="lblUsu" runat="server" Text="Usuario" ForeColor="#4682B4"></asp:Label>&nbsp;&nbsp;
            <asp:TextBox ID="txtUsuario" runat="server" class="form-control"  MaxLength="10" width="200px"></asp:TextBox>
            
            <br />
            <asp:Label ID="lblNom" runat="server" Text="Nombre completo" ForeColor="#4682B4"></asp:Label>&nbsp;&nbsp;
            <asp:TextBox ID="txtNom" runat="server" class="form-control"  MaxLength="100" width="200px"></asp:TextBox>
            
                <br />
            <asp:Label ID="lblEmail" runat="server" Text="Email" ForeColor="#4682B4"></asp:Label>&nbsp;&nbsp;
            <asp:TextBox ID="txtEmail" runat="server" class="form-control"  MaxLength="150" width="200px"></asp:TextBox>
             
            <br />
            <asp:Label ID="lblPerfil" runat="server" Text="Perfil" ForeColor="#4682B4"></asp:Label>&nbsp;&nbsp;
            <asp:DropDownList ID="cboPerfil" runat="server" class="form-control" width="200px"></asp:DropDownList>

            <br /><br />
            <asp:LinkButton id="btnRegistrar" runat="server" Text="Registrar"  OnClick="btnRegistrar_Click" CssClass="btn btn-info" BackColor="White" ForeColor="#4682B4">Registrar</asp:LinkButton>
            </center>
