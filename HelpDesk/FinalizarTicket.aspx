<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinalizarTicket.aspx.cs" Inherits="HelpDesk.FinalizarTicket" %>
    ...
    <form id="form1" runat="server">
        <div style="margin-left:20px;">
            ...
            <asp:Label ID="ticket" runat="server" ForeColor="#4682B4"></asp:Label><br /><br />
                ...
                <asp:TextBox ID="txtobs" runat="server" TextMode="MultiLine" MaxLength="500" class="form-control btn-round" Width="300px" Height="100px" onkeyDown=" contadorTexto(this.form.txtobs, this.form.txtContador, 500);" onkeyup="contadorTexto(this.form.txtobs, this.form.txtContador, 500);"></asp:TextBox><br />
                 <div style="margin-left:220px;">
                <asp:TextBox ID="txtContador" runat="server" ReadOnly="true" Width="40px"></asp:TextBox><asp:Label ID="lblContador" runat="server" Text="/500" ForeColor="#4682B4" Font-Size="Medium"></asp:Label>
                     </div>
                <br /><br />
