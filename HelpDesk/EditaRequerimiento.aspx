    ...
    <form id="form1" runat="server">
        <div style="margin-left:20px;">
           <asp:Label ID="Label1" runat="server" ForeColor="#4682B4" Text="Número de ticket: "></asp:Label>&nbsp;
            ...
            <div class="col-md-12" >
            <asp:Button ID="btnEditRq" class="col-md-offset-2" runat="server" OnClick="btnEditRq_Click" Text="Editar Requerimiento" CssClass="btn btn-info" ForeColor="White" BackColor="#4682B4" />
            <asp:Button ID="btnEditObs" runat="server" OnClick="btnEditObs_Click" Text="Editar Observaciones" CssClass="btn btn-info" ForeColor="White" BackColor="#4682B4" />
            <asp:Button ID="btnFinalizar" runat="server" OnClick="btnFinalizar_Click" Text="Finalizar" CssClass="btn btn-info" ForeColor="White" BackColor="#4682B4" />
                <br /><br />
            </div>
                ...
                <asp:Label ID="Obs" runat="server" Text="Observaciones: " ForeColor="#4682B4"></asp:Label>&nbsp;&nbsp;
                <asp:TextBox ID="txtObs" runat="server" TextMode="MultiLine" class="form-control"  MaxLength="200" onkeyDown=" contadorTexto(this.form.txtreq, this.form.txtContador, 200);" onkeyup="contadorTexto(this.form.txtObs, this.form.txtContador2, 200);"></asp:TextBox>
                <div style="margin-left:180px;">
                <asp:TextBox ID="txtContador2" runat="server" ReadOnly="true" Width="40px" ></asp:TextBox>
                <asp:Label ID="lblContador2" runat="server" Text="/200" ForeColor="#4682B4" Font-Size="Medium"></asp:Label><br />
                <br />
                
                </div>
                <asp:Label ID="lblImg" runat="server" Text="Seleccione para subir una imagen: " ForeColor="#4682B4" ></asp:Label>
                <asp:FileUpload ID="fileImg" runat="server" ToolTip="¿Desea subir una imagen?" CssClass="btn" ForeColor="#4682B4" Width="350px"/><br /><br />
                <asp:Label ID="lblCorrecto" runat="server" Text="" ForeColor="#33cc33"></asp:Label>
                 <asp:Label ID="lblError" runat="server" Text="" ForeColor="Red"></asp:Label>
                 <asp:Label ID="lblErrorVS" runat="server" Text="" ForeColor="Red" Visible="false"></asp:Label>
